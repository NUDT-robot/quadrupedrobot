...
#define QRCFFB 5
    Vector3d cffilter[8][QRCFFB];     //In first index, 4 size for force and 4 size for torque
...
private:
    ...
    inline void SetAttitude(Vector3d attitude){m_roll = attitude.X(); m_pitch = attitude.Y(); m_yaw = attitude.Z();}
...
/*Debug funtions*/
    ...
    {
        cout << "limb_frontleft joint theta1 : " << limb_frontleft.GetThetaPos(1) <<endl;
        cout << "limb_frontleft joint theta2 : " << limb_frontleft.GetThetaPos(2) << endl;
        cout << "limb_frontleft joint theta3 : " << limb_frontleft.GetThetaPos(3) << endl;
        cout << "limb_frontleft joint theta4 : " << limb_frontleft.GetThetaPos(4) << endl;
        cout << "limb_frontright joint theta1 : " << limb_frontright.GetThetaPos(1) << endl;
        cout << "limb_frontright joint theta2 : " << limb_frontright.GetThetaPos(2) << endl;
        cout << "limb_frontright joint theta3 : " << limb_frontright.GetThetaPos(3) << endl;
        cout << "limb_frontright joint theta4 : " << limb_frontright.GetThetaPos(4) << endl;
        cout << "limb_backleft joint theta1 : " << limb_backleft.GetThetaPos(1) << endl;
        cout << "limb_backleft joint theta2 : " << limb_backleft.GetThetaPos(2) << endl;
        cout << "limb_backleft joint theta3 : " << limb_backleft.GetThetaPos(3) << endl;
        cout << "limb_backleft joint theta4 : " << limb_backleft.GetThetaPos(4) << endl;
        cout << "limb_backright  joint theta1 : " << limb_backright.GetThetaPos(1) << endl;
        cout << "limb_backright joint theta2 : " << limb_backright.GetThetaPos(2) << endl;
        cout << "limb_backright joint theta3 : " << limb_backright.GetThetaPos(3) << endl;
        cout << "limb_backright joint theta4 : " << limb_backright.GetThetaPos(4) << endl;
    }
...
public:
    ...
    void GetLock() { if(m_SyncLock) {cout << "GetLock Work!!!" << endl; return;} m_SyncLock = true; }
...
/*TODO !*/
    //Trot gait, default value is 0.5m/s.
